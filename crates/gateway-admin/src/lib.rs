...
pub struct AdminRuntime {
    ...
    pub downstream_keepalive_idle_timeout_ms: u128,
    ...
    fn to_json(&self) -> String {
        format!(
            concat!(
                ...
                "\"downstream_keepalive_idle_timeout_ms\":{},",
            ...
            self.downstream_keepalive_idle_timeout_ms,
            self.downstream_keepalive_max_requests,
